...
$username = "if0_37488126";
$password = "makeciagreat";
$database = "if0_37488126_foro";
    ...
    <div class="inicio-container">
        <div class="grid-item">
            ...
            <div class="trabajador-semanal">
                <h5 class="trabajador-semanal-titulo">Trabajador del Mes</h5>
        ...
        if (($rango >= 2 && $rango <= 11 || $dev == 1) && $participa_sorteo == 0) {
            echo '
            <div class="sorteo-semanal">
    <div class="sorteo-info">
        <form method="POST" action="index.php?sorteo">
            <button type="submit" name="participar" class="sorteo-btn">
                Participar
            </button>
        </form>
    </div>
