            ...
            <div class="panel-body">
                <div style="float:left;margin:10px;height: auto;display: block;">
                    ...
                    <div style="float:left;margin-left:10px;">
                        ...
                        <div style="float:left;margin-left:10px;">
                            ...
                            <select required="" name="mision">
                                <?php
                                if ($rangouser >= 12) {
                                    $resultado = $link->query("SELECT * FROM misiones WHERE num >= 84 AND num <= 106 ORDER BY num ASC");
                                } 
                                while ($row = mysqli_fetch_array($resultado)) {
                    ...
                    if ($_POST['guardar'] && $_POST['user']) {
                        ...
                        if ($misionId >= 84 && $misionId <= 92) {
                            $nuevoRango = 9; 
                        } elseif ($misionId >= 93 && $misionId <= 100) {
                            $nuevoRango = 10; 
                        }  else if ($misionId >= 101 && $misionId <= 106) {
                            $nuevoRango = 12; 
                        } else {
