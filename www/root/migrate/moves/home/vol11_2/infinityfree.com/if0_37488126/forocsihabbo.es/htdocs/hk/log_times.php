...
while ($row = mysqli_fetch_array($query)) {
    ...
    if($username == 'juanmanue715' || $username == 'asgallardoj') {
        // Si el usuario es 'novalboschu', lo dejamos pasar sin restricciones.
        break;
    }
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-striped table-hover" id="userTable"> <!-- Agregar clases Bootstrap -->
                    ...
                    <tbody>
                        <?php
                        $resultado = $link->query("SELECT * FROM log_times $whereClause ORDER BY id DESC");
                        while ($row = mysqli_fetch_array($resultado)) {
                            ...
                            <tr>
                                ...
                                <!-- Aquí se muestra la diferencia en lugar de la fecha -->
                            </tr>
                            <?php
                        }
                        ?>
