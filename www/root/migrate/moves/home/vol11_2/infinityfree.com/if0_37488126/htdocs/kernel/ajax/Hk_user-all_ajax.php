...
if ($action == 'ajax') {
    ...
    $whereClause = !empty($search) ? "WHERE username LIKE '%$search%' AND rank <= 13" : "WHERE rank <=13";
    ...
    $query = $link->query("SELECT * FROM usuarios $whereClause ORDER BY rank ASC LIMIT $offset, $per_page");
        ...
        <table class="table table-striped table-hover ">
            ...
            while ($row = mysqli_fetch_array($query)) {
                ...
                <tr>
                    ...
                    <td><a href="editar/user-all.php?id=<?php echo "$row[ID]"; ?>"><button type="button" class="btn btn-sm btn-success"><span class="MPicon-pencil"></span></button></a></td>
                </tr>
                <?php
            }
            ?>
