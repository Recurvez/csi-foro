...
<table class="table table-striped table-hover ">
			  <thead>
				<tr>
                              ...
                              <th><?php echo $lang[422]; ?></th>
                              <th><?php echo $lang[423]; ?></th>
			...
			while($row = mysqli_fetch_array($query)){
				...
				<tr>
                              ...
                              <td><a href="editar/noticia.php?noticia=<?php echo "$row[id]"; ?>"><button type="button" class="btn btn-sm btn-success"><span class="MPicon-pencil"></span></button></a> <a href="eliminar/noticia.php?id=<?php echo "$row[id]"; ?>"><button type="button" class="btn btn-sm btn-danger"><span class="MPicon-cross"></span></button></a></td>
				</tr>
				<?php
			}
			?>
