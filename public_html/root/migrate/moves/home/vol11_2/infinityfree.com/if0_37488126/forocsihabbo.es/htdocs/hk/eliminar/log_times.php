...
$vaciar= "TRUNCATE TABLE log_times";
...
$accion = "Ha reiniciado los Logs de Tiempos";
$enviar_log = "INSERT INTO log_times (usuario,accion,fecha) values ('".$username."','".$accion."','".$fecha_log."')";
