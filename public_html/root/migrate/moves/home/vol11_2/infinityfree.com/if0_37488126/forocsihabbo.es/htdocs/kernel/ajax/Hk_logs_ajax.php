...
if ($action == 'ajax') {
    ...
    $count_query   = $link->query("SELECT count(*) AS numrows FROM logs $whereClause");
    ...
    $query = $link->query("SELECT * FROM logs $whereClause ORDER BY id DESC LIMIT $offset, $per_page");
