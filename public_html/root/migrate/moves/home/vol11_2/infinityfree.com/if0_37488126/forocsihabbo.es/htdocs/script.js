document.addEventListener("DOMContentLoaded", function () {
    ...
    }, 2500); // Se desvanece después de 2.5 segundos
});
...
navLinks.forEach((link, index) => {
    link.addEventListener("click", (e) => {
        ...
        if (link.getAttribute("href") === "login.php" || link.getAttribute("href") === "#" || link.getAttribute("href") === "/hk/index.php" || link.getAttribute("href") === "kernel/login/cerrar.php") {
...
function actualizarCarrusel(rango) {
    ...
    miembrosVisibles.forEach(miembro => {
        ...
        miembroDiv.innerHTML = `
            ...
            <div class="mottouserperfil">${miembro.motto}</div>
            <div class="mottouserperfil">[${miembro.TAG}]</div>
        `;
...
// SCRIPTS MODAL NAVBAR

function inicializarPerfilModal() {
    let modal = document.getElementById("perfil-modal");
    let btnAbrir = document.getElementById("abrir-perfil-modal");
    let btnCerrar = document.querySelector("#perfil-modal .perfil-close");
