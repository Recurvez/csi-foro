        ...
        <div class="panel panel-default">
            <div class="panel-heading blue">
                ...
                <div style="float: right;">
                    <input type="text" id="search" placeholder="Buscar usuario..." class="form-control" style="width: 200px; display: inline-block;">
                </div>
            </div>
                            ...
                            if ($link->query($enviar)) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = 'http://www.forociahabbo.wuaze.com/hk/index.php';
                                    }
                                });
                                </script>";
                            } else {
