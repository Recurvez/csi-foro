...
<table class="table table-striped table-hover ">
			...
			while($row = mysqli_fetch_array($query)){
				...
				<tr>
                              ...
                              <td><a href="editar/placa.php?id=<?php echo "$row[id]"; ?>"><button type="button" class="btn btn-sm btn-success"><span class="MPicon-pencil"></span></button></a> <a href="eliminar/placa.php?id=<?php echo "$row[id]"; ?>"><button type="button" class="btn btn-sm btn-danger"><span class="MPicon-cross"></span></button></a></td>
				</tr>
				<?php
			}
			?>
