...
// Usuario user
$dbusername 	= "forocsihabbo_for";		 

// Contraseña , password	
$dbuserpass 	= "makeciagreat"; 	

// Nombre de base de datos db
$dbname 		= "forocsihabbo_for"; 
...
<h2>$username Tu cuenta ha sido bloqueada</h2>
<br>
...
$accion = "Ha iniciado sesión con otra ip (La cuenta ha sido bloqueada)";
